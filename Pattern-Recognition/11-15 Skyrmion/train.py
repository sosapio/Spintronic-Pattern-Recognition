...
parser.add_argument('--onoffratio', default=3)
...
parser.add_argument('--max_level', default=32)
...
parser.add_argument('--sigmaReadNoise', default=0.01)
        ...
        for batch_idx, (data, target) in enumerate(train_loader):
            ...
            if args.readNoise:
                ...
                for name, param in list(model.named_parameters())[::-1]:
                    ...
                    noise = torch.normal(mean=1, std=torch.ones_like(r_states)*args.sigmaReadNoise)
